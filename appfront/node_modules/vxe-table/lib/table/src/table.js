  ...
  setup: function setup(props, context) {
    ...
    var setMerges = function setMerges(merges, mList, rowList) {
      if (merges) {
        ...
        if (treeConfig) {
          (0, _log.errLog)('vxe.error.noTree', ['merge-footer-items']);
          return;
        }
    ...
    var removeMerges = function removeMerges(merges, mList, rowList) {
      ...
      if (merges) {
        ...
        if (treeConfig) {
          throw new Error((0, _log.getLog)('vxe.error.noTree', ['merge-cells']));
        }
          ...
          if (process.env.NODE_ENV === 'development') {
            ...
            fullData.forEach(function (row) {
              if (row[treeOpts.children] && row[treeOpts.children].length) {
                (0, _log.warnLog)('vxe.error.errConflicts', ['tree-config.transform', "row." + treeOpts.children]);
              }
            });
          }
      ...
      refreshScroll: function refreshScroll() {
        ...
        return new Promise(function (resolve) {
          ...
          if (lastScrollLeft || lastScrollTop) {
            return (0, _util.restoreScrollLocation)($xetable, lastScrollLeft, lastScrollTop).then(resolve).then(function () {
              // 存在滚动行为未结束情况
      ...
      (0, _vue.nextTick)(function () {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          if (importConfig && importOpts.types && !importOpts.importMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.config.importTypes, importOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', ["export-config.types=" + importOpts.types.join(','), importOpts.types.filter(function (type) {
          ...
          if (exportConfig && exportOpts.types && !exportOpts.exportMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.config.exportTypes, exportOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', ["export-config.types=" + exportOpts.types.join(','), exportOpts.types.filter(function (type) {
